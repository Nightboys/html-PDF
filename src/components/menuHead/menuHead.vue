...
export default {
  ...
  watch: {
    menus: {
      deep: true,
      handler() {
        // console.log('----------watch menus',this.showList.length)

        //  if (this.showList.length === 0) {
        //  console.log('menus handler')
        this.init();
        //  }
  ...
  methods: {
    init() {
      ...
      //debugger
      if (this.init_time === this.showList.length) {
        // console.log('is--------true', this.init_time);
        this.first_list = [...this.showList];
      }
    },
    reset(index) {
      // console.log('is reset', index);
      // console.log(this.showList)

      // console.log('-------------ppppp--------')
      // console.log(this.showList[index].list)

      // console.log('first_list',this.first_list)
      // console.log(this.first_list[index].list)
      ...
      if (this.showList[index].canReset) {
        ...
        //  this.$set(this.list, index, $.extend(true, {}, this.first_list.list));
    ...
    submit(o) {
      // console.log($.extend(true, {}, o), 'o');
      // let menu = this.list[o.idx];

      // console.log('menuhead submit');
      ...
      // console.log(o.selectList, 'selectList');
      // wuzq2修改
      this.list[o.idx].selectName = o.selectList.length;
